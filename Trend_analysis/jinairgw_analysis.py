# -*- coding: utf-8 -*-
"""JinAirGW_analysis.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pYjj-BCvm-i2FoHZL65oJStl4PNdyT4Y
"""
...
for root, dirs, files in os.walk(os.path.join('data','JinAirGW')):
    for fname in files:
